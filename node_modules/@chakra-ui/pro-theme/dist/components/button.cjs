...
const vars = styledSystem.defineCssVars("button", ["bg", "color"]);
const variants = {
  primary: styledSystem.defineStyle((props) => {
  ...
  secondary: styledSystem.defineStyle({
    borderWidth: "1px",
  ...
  tertiary: styledSystem.defineStyle({
    borderRadius: "lg",
    flexShrink: 0,
    bg: vars.bg.reference,
    color: vars.color.reference,
  ...
  text: styledSystem.defineStyle((props) => {
    const { colorScheme } = props;
  ...
  "primary.accent": styledSystem.defineStyle(() => {
    return {
      bg: "brand.50",
      color: "brand.600",
      _hover: { bg: "brand.100" },
  ...
  "tertiary.accent": styledSystem.defineStyle((props) => ({
    color: "brand.50",
    _hover: {
      bg: themeTools.transparentize("brand.500", 0.67)(props.theme)
    },
    _activeLink: {
      color: "white",
      bg: "bg.accent.subtle"
  ...
  "text.accent": styledSystem.defineStyle({
    padding: 0,
    height: "auto",
    lineHeight: "normal",
    verticalAlign: "baseline",
...
const button = styledSystem.defineStyleConfig({
  variants,
  sizes,
  defaultProps: {
    colorScheme: "brand"
